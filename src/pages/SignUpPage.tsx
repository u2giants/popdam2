        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-md mt-16">
            ...
            <p className="text-slate-400 text-[15px] leading-relaxed mb-10">
              Registration is invite-only. An admin must create an invitation for your email address before you can access the platform.
            </p>

            <div className="space-y-3">
              {[
                { step: '01', title: 'Get invited', desc: 'Ask your admin to send you an invitation ID' },
                { step: '02', title: 'Register', desc: 'Use the invitation ID and your email to create an account' },
                { step: '03', title: 'Access granted', desc: 'Sign in and start browsing your team\'s assets' },
              ].map(({ step, title, desc }) => (
                <div key={step} className="flex items-start gap-4 p-4 rounded-xl bg-slate-800/40 border border-slate-800/60">
                  <span className="text-xs font-bold text-brand-500 font-mono flex-shrink-0 mt-0.5">{step}</span>
                  <div>
        ...
        <div className="w-full max-w-[360px] mx-auto">
          ...
          {success ? (
            <div className="animate-fade-in text-center">
              <div className="w-16 h-16 bg-emerald-900/30 border border-emerald-800/40 rounded-2xl flex items-center justify-center mx-auto mb-6">
                <CheckCircle className="w-8 h-8 text-emerald-400" />
              </div>
              <h2 className="text-xl font-semibold text-white mb-2">Account created</h2>
              <p className="text-[13px] text-slate-500 mb-8">
                Your account is ready. Sign in with your credentials to continue.
              </p>
              <button className="btn-primary w-full py-3 text-[13px]" onClick={onShowLogin}>
                Go to sign in
              </button>
            </div>
          ) : (
            <>
              <div className="mb-8">
                ...
                <p className="text-[13px] text-slate-500">Use an invitation to register, or sign in with SSO</p>
              </div>
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-slate-950 px-3 text-[11px] font-medium text-slate-600 uppercase tracking-wider">register with invitation</span>
                </div>
              </div>

              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-[11px] font-semibold text-slate-500 uppercase tracking-wider mb-2">Invitation ID</label>
                  <input
                    type="text"
                    className="input py-2.5 font-mono text-xs tracking-wide"
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Must match the invitation"
                    value={email}
